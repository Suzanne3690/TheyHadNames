...
```r
indata <- read.csv("AfricanNamesDatabase.csv", stringsAsFactors = FALSE)
```
...
##  $ id      : chr  "1" "2" "3" "4" ...
##  $ name    : chr  "Bora" "Flam" "Dee" "Pao" ...
##  $ age     : int  30 30 28 22 16 22 20 30 18 23 ...
##  $ height  : num  62.5 64 65 62.5 59 67.5 62 65.5 61.5 62 ...
##  $ sexage  : chr  "Man" "Man" "Man" "Man" ...
##  $ country : chr  "" "" "" "Crue" ...
##  $ voyageId: int  2314 2315 2315 2315 2315 2315 2315 2315 2315 2315 ...
##  $ shipname: chr  "NS de Regla" "Fabiana" "Fabiana" "Fabiana" ...
##  $ datearr : int  1819 1819 1819 1819 1819 1819 1819 1819 1819 1819 ...
##  $ majbuypt: chr  "Little Bassa" "Trade Town" "Trade Town" "Trade Town" ...
##  $ majselpt: chr  "Freetown" "Freetown" "Freetown" "Freetown" ...
##  $ source  : chr  "FO84/4" "FO84/4" "FO84/4" "FO84/4" ...
```


In this segment, we will be mostly using the _name_, _age_ and _height_ variables. (Height is reported in inches.) 
